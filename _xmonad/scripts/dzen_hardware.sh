...
cpu_bar_0=`$HOME/.xmonad/scripts/bar_cpu.sh 1`
cpu_bar_1=`$HOME/.xmonad/scripts/bar_cpu.sh 2`
cpu_bar_2=`$HOME/.xmonad/scripts/bar_cpu.sh 3`
cpu_bar_3=`$HOME/.xmonad/scripts/bar_cpu.sh 4`

mem_bar=`$HOME/.xmonad/scripts/bar_ram_lg.sh`
